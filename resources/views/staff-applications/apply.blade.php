...
<head>
    ...
    <title>Staff Application - Yuva Maitree Foundation</title>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="text-center mb-8">
            <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">Staff Member Application</h2>
            <p class="text-lg text-gray-600">स्टाफ सदस्य आवेदन</p>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                            @error('email')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="designation" id="designation" value="{{ old('designation') }}" placeholder="e.g. Field Worker, Coordinator" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                            @error('designation')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
        ...
        <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p class="text-sm text-blue-800">
                <strong>Note:</strong> Your application will be reviewed by our admin team. Once approved, you will be verified as a staff member and your Staff ID will be generated. For any queries, please contact us.
            </p>
        </div>
    </div>
