...
<head>
    ...
    <title>Contact Us - Yuva Maitree Foundation</title>
...
<body class="bg-white text-gray-800">
    ...
    <section class="bg-gradient-to-r from-[#1b6a3c] to-green-700 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="text-xl text-green-100">हमसे संपर्क करें</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900 text-lg mb-1">Working Hours</h3>
                                <p class="text-gray-600">
                    ...
                    <div class="mt-12">
                        <h3 class="font-semibold text-gray-900 text-lg mb-4">Follow Us</h3>
                        <div class="flex gap-4">
                            <a href="#" class="w-10 h-10 bg-gray-100 hover:bg-orange-500 hover:text-white rounded-full flex items-center justify-center transition">
                ...
                <div class="bg-gray-50 rounded-2xl p-8 lg:p-10">
                    ...
                    <form action="#" method="POST" class="space-y-6">
                        ...
                        {{-- Submit Button --}}
                        <button type="submit" class="w-full px-6 py-4 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition text-lg">
                            Send Message
                        </button>
                    </form>
                </div>
    ...
    {{-- Map Section (Optional - you can add actual map embed later) --}}
    <section class="py-16 bg-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8">
                <h2 class="text-3xl font-bold text-gray-900 mb-2">Find Us On Map</h2>
                <p class="text-gray-600">Visit our office during working hours</p>
            </div>
            ...
            <div class="bg-gray-300 rounded-xl h-96 flex items-center justify-center">
                <div class="text-center">
                    ...
                    <p class="text-gray-600">Google Maps will be embedded here</p>
                </div>
            </div>
        </div>
    </section>
