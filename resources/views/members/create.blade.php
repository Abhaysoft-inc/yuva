                        ...
                        <fieldset class="border border-gray-200 rounded-lg p-4 mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                <div>
                                    ...
                                    <x-text-input id="fd_amount" name="fd_amount" type="number" step="0.01" class="mt-1 block w-full" :value="old('fd_amount', '1000')" placeholder="e.g. 1000" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="fd_interest_rate" name="fd_interest_rate" type="number" step="0.01" class="mt-1 block w-full" :value="old('fd_interest_rate', '12')" placeholder="e.g. 12" />
