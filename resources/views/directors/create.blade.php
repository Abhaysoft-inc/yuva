                    ...
                    <form action="{{ route('directors.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            <label for="photo" class="block text-sm font-medium text-gray-700 mb-2">
                                Photo * <span class="text-gray-500 text-xs">(Recommended: 400x500px portrait)</span>
                            </label>
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="e.g., DIRECTOR, BOARD OF DIRECTOR" required
