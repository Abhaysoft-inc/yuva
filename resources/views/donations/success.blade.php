...
<head>
    ...
    <title>Thank You for Your Donation - Yuva Maitree Foundation</title>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 md:p-12 text-center">
                ...
                <div class="bg-gray-50 rounded-xl p-6 mb-8 text-left">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-mono text-sm text-gray-700">{{ $donation->razorpay_payment_id }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Payment Method:</span>
                            <span class="font-semibold text-gray-900">{{ ucfirst($donation->payment_method ?? 'Online') }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-orange-50 border border-orange-200 rounded-xl p-4 mb-8">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="text-left">
                            <h3 class="font-semibold text-orange-900 mb-1">80G Tax Exemption Certificate</h3>
                            <p class="text-sm text-orange-800">Your tax exemption certificate will be sent to your registered email within 7 working days.</p>
                        </div>
                    </div>
                </div>
                @endif
                ...
                <div class="border-t border-gray-200 pt-6 mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-gray-700">Funds allocated to programs</p>
                        </div>
                        <div class="flex flex-col items-center">
                            <div class="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center mb-2">
                                <span class="text-blue-600 font-bold">3</span>
                            </div>
                            <p class="text-gray-700">Updates on impact created</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 pt-6 border-t border-gray-200">
                    ...
                    <div class="flex justify-center gap-2">
                        ...
                        <a href="https://twitter.com/intent/tweet?text=I+just+donated+to+Yuva+Maitree+Foundation" target="_blank"
                        ...
                        <a href="https://wa.me/?text=I+just+supported+Yuva+Maitree+Foundation" target="_blank"
