            ...
            <div class="mb-6">
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Update staff user account details</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-8 max-w-2xl">
                <form action="{{ route('staff.update', $staff) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                        <p class="text-gray-500 text-sm mt-1">Leave blank to keep current password. Minimum 8 characters if changing.</p>
                    </div>
