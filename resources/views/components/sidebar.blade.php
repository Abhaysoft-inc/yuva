    ...
    <aside x-show="sidebarOpen" 
        ...
        <div class="p-4">
            ...
            <nav class="space-y-1">
                ...
                <a href="{{ route('members.index') }}" @click="sidebarOpen = false" class="flex items-center px-4 py-3 text-white sidebar-hover rounded-lg transition {{ request()->routeIs('members.index') || request()->routeIs('members.show') || request()->routeIs('members.edit') ? 'sidebar-active' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <aside class="hidden lg:block w-64 sidebar-bg min-h-screen fixed left-0 top-0 overflow-y-auto z-40">
        <div class="p-4">
            ...
            <nav class="space-y-1">
                ...
                {{-- Verified Members --}}
                <a href="{{ route('members.index') }}" class="flex items-center px-4 py-3 text-white sidebar-hover rounded-lg transition {{ request()->routeIs('members.index') || request()->routeIs('members.show') || request()->routeIs('members.edit') ? 'sidebar-active' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                    <span class="font-medium text-sm">VERIFIED MEMBERS</span>
