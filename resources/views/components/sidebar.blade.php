    ...
    <aside x-show="sidebarOpen" 
        ...
        <div class="p-4">
            ...
            <nav class="space-y-1">
                ...
                {{-- Admin-only sections --}}
                {{-- Staff Management --}}
                <a href="{{ route('staff.index') }}" @click="sidebarOpen = false" class="flex items-center px-4 py-3 text-white hover:bg-blue-700 rounded-lg transition {{ request()->routeIs('staff.*') ? 'bg-blue-700' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {{-- Donations --}}
                <a href="{{ route('donations.index') }}" @click="sidebarOpen = false" class="flex items-center px-4 py-3 text-white hover:bg-blue-700 rounded-lg transition {{ request()->routeIs('donations.*') ? 'bg-blue-700' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('settings.contact') }}" @click="sidebarOpen = false" class="flex items-center px-4 py-3 text-white hover:bg-blue-700 rounded-lg transition {{ request()->routeIs('settings.*') ? 'bg-blue-700' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <aside class="hidden lg:block w-64 bg-[#1e3a8a] min-h-screen fixed left-0 top-0 overflow-y-auto z-40">
        <div class="p-4">
            ...
            <nav class="space-y-1">
                ...
                {{-- Admin-only sections --}}
                {{-- Staff Management --}}
                <a href="{{ route('staff.index') }}" class="flex items-center px-4 py-3 text-white hover:bg-blue-700 rounded-lg transition {{ request()->routeIs('staff.*') ? 'bg-blue-700' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    <span class="font-medium text-sm">STAFF MANAGEMENT</span>
                ...
                {{-- Donations --}}
                <a href="{{ route('donations.index') }}" class="flex items-center px-4 py-3 text-white hover:bg-blue-700 rounded-lg transition {{ request()->routeIs('donations.*') ? 'bg-blue-700' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span class="font-medium text-sm">DONATIONS</span>
                ...
                {{-- Contact Info Settings --}}
                <a href="{{ route('settings.contact') }}" class="flex items-center px-4 py-3 text-white hover:bg-blue-700 rounded-lg transition {{ request()->routeIs('settings.*') ? 'bg-blue-700' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    <span class="font-medium text-sm">CONTACT INFO</span>
