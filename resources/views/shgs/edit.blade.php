                        ...
                        <fieldset class="border border-gray-200 rounded-lg p-4 mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="date_of_formation" name="date_of_formation" type="text" class="mt-1 block w-full date-input" placeholder="dd/mm/yyyy" :value="old('date_of_formation', $shg->date_of_formation?->format('d/m/Y'))" />
